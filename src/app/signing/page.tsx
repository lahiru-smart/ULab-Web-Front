...
const Signing = () => {
    return (
        <div className="relative overflow-hidden z-10 pt-[180px] pb-[120px]">
    <div className="container">
      <div className="flex flex-wrap mx-[-16px]">
        <div className="w-full px-4">
          <div className="max-w-[500px] mx-auto bg-primary bg-opacity-5 dark:bg-dark rounded-md p-12 sm:p-[60px]">
            <h3 className="font-bold text-black dark:text-white text-2xl sm:text-3xl mb-3 text-center">Sign in to your
              account</h3>
            <p className="font-medium text-base text-body-color mb-11 text-center">Login to your account for a faster
              checkout.</p>
            <button
            ...
            <div className="flex items-center justify-center mb-8">
              <span className="hidden sm:block max-w-[70px] w-full h-[1px] bg-body-color"></span>
            ...
            <form>
              ...
              <div className="flex items-center justify-between mb-8">
                ...
                <div>
                  <a href="javascript:void(0)" className="text-primary text-sm font-medium hover:underline"> Forgot
                    Password? </a>
                </div>
              </div>
              <div className="mb-6">
            ...
            <p className="font-medium text-base text-body-color text-center">
              ...
              <a href="signup.html" className="text-primary hover:underline"> Sign up </a>
            </p>
          </div>
        </div>
      </div>
