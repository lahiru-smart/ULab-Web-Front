        ...
        <div className="w-full md:w-1/2 lg:w-4/12 xl:w-5/12 px-4">
          <div className="mb-16 max-w-[360px]">
            <a href="index.html" className="inline-block mb-8">
              <img src="/logo/logo-2.svg" alt="logo" className="w-full dark:hidden" />
              <img src="/logo/logo.svg" alt="logo" className="w-full hidden dark:block" />
            </a>
            ...
            <div className="flex items-center">
              <a href="javascript:void(0)" aria-label="social-link" className="text-[#CED3F6] hover:text-primary mr-6">
